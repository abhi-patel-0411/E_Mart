    ...
    <div>
      ...
      <div className="hero-slide" style={{
        ...
        <div className="container text-center text-white">
          <h1 className="display-2 fw-bold mb-4" data-aos="fade-up">Secure Payment</h1>
          <p className="lead mb-5" data-aos="fade-up" data-aos-delay="200">Complete your purchase with confidence</p>
        </div>
      </div>
      ...
      <section className="py-5 bg-light">
        <div className="container">
          <div className="text-center mb-5" data-aos="fade-up">
            ...
            <p className="text-muted fs-5">Secure checkout powered by Stripe - Your payment information is protected</p>
          </div>
                ...
                <div className="card-body p-4">
                      ...
                      <div key={item.id} className="d-flex justify-content-between align-items-center py-2 border-bottom">
                        ...
                        <div className="text-end">
                          <span className="text-dark fw-bold">
                            ₹{parseFloat(item.cost || item.product.price * item.quantity).toLocaleString()}
                          </span>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="summary-totals">
                    <div className="d-flex justify-content-between mb-2">
                      ...
                      <span className="text-dark">₹{amount.toLocaleString()}</span>
                    </div>
                    <div className="d-flex justify-content-between mb-2">
                    ...
                    <div className="d-flex justify-content-between pt-3 border-top">
                      ...
                      <h4 className="text-success fw-bold">₹{amount.toLocaleString()}</h4>
                    </div>
                  </div>
                  ...
                  <div className="security-badges mt-4 p-3 bg-light rounded">
                    <div className="row g-2 text-center">
                      ...
                      <div className="col-4">
                        ...
                        <small className="d-block text-muted mt-1">Stripe</small>
                      </div>
                    </div>
                  </div>
                </div>
